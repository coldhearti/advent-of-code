...
def main():
    solutions = {
        ...
        "Day 6 part 1, Characters processed before first start-of-packet": (day_6.solve_part_1, "./inputs/day_6"),
        ...
        "Day 11 part 1, Level of monkey business after 20 rounds": (day_11.solve_part_1, "./inputs/day_11"),
        "Day 11 part 2, Level of monkey business after 10 000 rounds": (day_11.solve_part_2, "./inputs/day_11"),
